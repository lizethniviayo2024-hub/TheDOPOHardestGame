...
public class GamePanel extends JPanel implements KeyListener {
    ...
    public void setOnExitToMenu(Runnable r) { onExitToMenu = r; }
    ...
    /**
     * Llamado externamente cuando ocurre un timeout para reiniciar el nivel.
     * Delega a Board.resetLevel() que registra la muerte en ScoreController
     * con el nombre de cada jugador humano — no usa addDeath() anónimo (Bug 6).
     */
    public void addDeath() {
        if (board != null) board.resetLevel();
    }
}